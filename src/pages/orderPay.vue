  ...
  .wrapper {
    ...
    .order-wrap {
      ...
      .item-order {
        ...
        .icon-succ {
          ...
          height: 90px;
          border-radius: 50%;
          background: url("../image/imgs/icon-gou.png") #80c58a no-repeat center;
        ...
        .order-total {
          ...
          .icon-down {
            ...
            width: 14px;
            height: 10px;
            background: url("../image/imgs/icon-down.png") no-repeat center;
    ...
    .item-pay {
      ...
      .pay-way {
        ...
        .pay-ali {
          background: url("../image/imgs/pay/icon-ali.png") no-repeat center;
          background-size: 103px 38px;
          margin-top: 19px;
        }
        .pay-wechat {
          background: url("../image/imgs/pay/icon-wechat.png") no-repeat center;
          background-size: 103px 38px;
        }
      }
    }
