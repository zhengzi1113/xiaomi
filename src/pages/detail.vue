  ...
  <div class="detail">
      ...
      <div class="container clearfix">
        <div class="swiper">
          ...
          <swiper :options="swiperOption">
            <swiper-slide
              ><img src="../image/imgs/detail/phone-1.jpg" alt=""
            /></swiper-slide>
            <swiper-slide
              ><img src="../image/imgs/detail/phone-2.jpg" alt=""
            /></swiper-slide>
            <swiper-slide
              ><img src="../image/imgs/detail/phone-3.jpg" alt=""
            /></swiper-slide>
            <swiper-slide
              ><img src="../image/imgs/detail/phone-4.jpg" alt=""
            /></swiper-slide>
            <!-- Optional controls -->
    ...
    <div class="price-info">
      <div class="container">
        <h2>价格说明</h2>
        <div class="desc">
          <img src="../image/imgs/detail/item-price.jpeg" alt="" />
        </div>
      </div>
    </div>
